...
//        _dateFormatter.dateFormat = @"ccc d MMM";
        ...
        _dateFormatter.dateFormat = @"MM 月 dd 日";
    }
...
- (NSDateFormatter *)monthAndYearLabelDateFormater {
    if (!_monthAndYearLabelDateFormater) {
        ...
        _monthAndYearLabelDateFormater.dateFormat = @"yyyy 年 MM 月";
    }
...
- (NSString *)confirmButtonTitle {
    if (!_confirmButtonTitle) {
        _confirmButtonTitle = NSLocalizedString(@"确认", @"HSDatePicker confirm button title");
    }
...
- (NSString *)backButtonTitle {
    if (!_backButtonTitle) {
        _backButtonTitle = NSLocalizedString(@"返回", @"HSDatePicker back button");
    }
